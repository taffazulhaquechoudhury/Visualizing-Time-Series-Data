# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 19:58:26 2020
...
def create_app_ui():
  ...
  main_layout = html.Div(
      style={"background": " linear-gradient(110deg, #008080 60%, #3CB371 60%)"},
      className="Test",
      children=[
  html.H1('Terrorism Analysis with Insights', id='Main_title',style={"text-align": "center","background-color": "#4682B4","margin":"0","padding-top": "7px","padding-bottom": "7px"}),
    dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(label="Map tool   "	 ,selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"},id="Map tool",value="Map",children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap",children = [
              dcc.Tab(label="World Map tool   "	,selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"}, id="World", value="WorldMap"),
              dcc.Tab(label="India Map tool   ",selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"}, id="India", value="IndiaMap")
              ]),
          dcc.Dropdown(
              id='month', 
                options=month_list,
      ...
      dcc.Tab(label = "Chart Tool   " ,selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"}, id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
              dcc.Tab(label="World Chart tool   ",selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"}, id="WorldC", value="WorldChart"),          
            dcc.Tab(label="India Chart tool   ",selected_style={"fontWeight": "bold"},style={"fontWeight": "bold"}, id="IndiaC", value="IndiaChart")]),
    ...
    dcc.Loading(children=[dcc.Graph(id='graph-object')],type='graph',style={"backgroundColor": "transparent","z-index":"9999","position":"absolute"}),
    html.Footer(id= "footer",
        style={"padding-bottom": "1px"},
        children=[
            html.H3(style={"text-align": "right"},children=[
                html.H3(children="A Project  ",style={"display": "inline"}),
                
                html.H3(children=" by Taffazul Haque Choudhury",style={"display": "inline"}),
                ]) 
            ])
